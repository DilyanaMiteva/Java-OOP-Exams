...
public class BankVaultTest {
    ...
    private static final String owner1 = "Test_name_1";
    private static final String owner2 = "Test_name_2";
    private static final String  itemId1 = "564";
    private static final String  itemId2 = "987";
    private static  Item item1;
    private static  Item item2;
    private static final String testInvalidCeil = "abv";
    private static final String testValidCeil1 = "A1";
    private static String testValidCeil2 = "A2";
